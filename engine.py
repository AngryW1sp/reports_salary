...
def generate_payout_report(workers: list[dict]) -> str:
    """""
    Генерирует текстовый отчёт по выплатам сотрудников, сгруппированный по департаментам.

    Для каждого департамента отображается список сотрудников с указанием:
    - имени,
    - отработанных часов,
    - часовой ставки,
    - суммы выплат.

    В конце каждого блока департамента указывается общее количество часов и суммарная выплата
    """""
